      ...
      <div className="bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500 sticky top-0 z-10 shadow-lg">
        <div className="flex items-center justify-between px-4 h-14">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-white">个人资料</h2>
          </div>
          ...
          {!isEditing ? (
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="px-4 py-2 text-white/90 hover:text-white text-sm"
              >
                取消
              </button>
              <button
                onClick={handleSave}
                className="flex items-center gap-2 px-4 py-2 bg-white text-purple-600 rounded-lg hover:shadow-lg transition-all"
              >
          ...
          <div className="flex items-center gap-5 mb-6">
            <div className="relative">
              ...
              {isEditing && (
                <button
                  aria-label="更换头像"
                  className="absolute -bottom-1 -right-1 w-8 h-8 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full flex items-center justify-center text-white shadow-lg hover:scale-110 transition-all"
                >
            ...
            <div className="flex-1">
              {isEditing ? (
                ...
                <div>
                  <h2 className="mb-1">{userInfo.nickname}</h2>
